...
def setting_ua():
	...
	if ua =="":
		...
		print("Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36;]")
		os.system("rm -f .ua")
		time.sleep(1)
